...
const usersRoutes = require('./routes/users'); // Importa as rotas dos usuarios

const estoqueCosmeticosRoutes = require('./routes/estoquecosmeticos'); // Importa as rotas dos usuarios
...
// Usar as rotas de pedidos para todas as requisições que começam com /api/users
app.use('/api/users', usersRoutes);

app.use('/api/estoquecosmeticos', estoqueCosmeticosRoutes);
